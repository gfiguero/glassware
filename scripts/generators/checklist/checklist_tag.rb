...
class ChecklistTagScaffold
  BASE_COMMAND_GENERATE = 'rails g scaffold aim/checklist/ChecklistTag'
  BASE_COMMAND_DESTROY = 'rails d scaffold aim/checklist/ChecklistTag'
  TABLE_NAME = 'aim_checklist_tags'
