FactoryBot.define do
  factory :map do
    ...
    add_attribute(:created_at) { "2023-10-19 21:34:47" }
    add_attribute(:updated_at) { "2023-10-19 21:34:47" }
    add_attribute(:last_update) { "2023-10-19 21:34:47" }
    add_attribute(:last_change) { "2023-10-19 21:34:47" }
    ...
    add_attribute(:authorization_user_manual_updated_at) { "2023-10-19 21:34:47" }
    ...
    add_attribute(:deleted_at) { "2023-10-19 21:34:47" }
