FactoryBot.define do
  factory :aim_checklist_checklist, class: 'Aim::Checklist::Checklist' do
    ...
    add_attribute(:started_at) { "2023-09-04 15:55:48" }
    add_attribute(:created_at) { "2023-09-04 15:55:48" }
    add_attribute(:updated_at) { "2023-09-04 15:55:48" }
    add_attribute(:finished_at) { "2023-09-04 15:55:48" }
