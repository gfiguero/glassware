FactoryBot.define do
  factory :aim_core_map, class: 'Aim::Core::Map' do
    add_attribute(:aim_maps) { "MyString" }
    ...
    add_attribute(:created_at) { "2023-09-04 17:15:27" }
    add_attribute(:updated_at) { "2023-09-04 17:15:27" }
    add_attribute(:last_update) { "2023-09-04 17:15:27" }
    add_attribute(:last_change) { "2023-09-04 17:15:27" }
    ...
    add_attribute(:authorization_user_manual_updated_at) { "2023-09-04 17:15:27" }
    ...
    add_attribute(:deleted_at) { "2023-09-04 17:15:27" }
