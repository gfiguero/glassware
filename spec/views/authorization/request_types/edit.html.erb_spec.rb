...
RSpec.describe "authorization/request_types/edit", type: :view do
  let(:authorization_request_type) {
  ...
  before(:each) do
    assign(:authorization_request_type, authorization_request_type)
  end

  it "renders the edit authorization_request_type form" do
    render

    assert_select "form[action=?][method=?]", authorization_request_type_path(authorization_request_type), "post" do
