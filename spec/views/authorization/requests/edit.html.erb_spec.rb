...
RSpec.describe "authorization/requests/edit", type: :view do
  ...
  before(:each) do
    assign(:authorization_request, authorization_request)
  end

  it "renders the edit authorization_request form" do
    render

    assert_select "form[action=?][method=?]", authorization_request_path(authorization_request), "post" do
