...
RSpec.describe "aim/checklist/checklist_interfaces/edit", type: :view do
  let(:aim/checklist_checklist_interface) {
  ...
  before(:each) do
    assign(:aim/checklist_checklist_interface, aim/checklist_checklist_interface)
  end

  it "renders the edit aim/checklist_checklist_interface form" do
    render

    assert_select "form[action=?][method=?]", aim/checklist_checklist_interface_path(aim/checklist_checklist_interface), "post" do

      assert_select "input[name=?]", "aim/checklist_checklist_interface[name]"
