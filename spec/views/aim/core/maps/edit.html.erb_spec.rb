...
RSpec.describe "aim/core/maps/edit", type: :view do
  let(:aim/core_map) {
    Aim::Core::Map.create!(
      aim_maps: "MyString",
      name: "MyString",
  ...
  before(:each) do
    assign(:aim/core_map, aim/core_map)
  end

  it "renders the edit aim/core_map form" do
    render

    assert_select "form[action=?][method=?]", aim/core_map_path(aim/core_map), "post" do

      assert_select "input[name=?]", "aim/core_map[aim_maps]"
      ...
      assert_select "input[name=?]", "aim/core_map[alias]"

      assert_select "input[name=?]", "aim/core_map[zoom_matrix]"

      assert_select "input[name=?]", "aim/core_map[adjustment_data]"

      assert_select "input[name=?]", "aim/core_map[map_radius]"

      assert_select "input[name=?]", "aim/core_map[map_latitude]"

      assert_select "input[name=?]", "aim/core_map[map_longitude]"
      ...
      assert_select "input[name=?]", "aim/core_map[map_classification_id]"

      assert_select "input[name=?]", "aim/core_map[map_district_id]"

      assert_select "input[name=?]", "aim/core_map[map_orientation]"
