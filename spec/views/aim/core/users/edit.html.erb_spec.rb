...
RSpec.describe('aim/core/users/edit', type: :view) do
  let(:aim / core_user) do
  ...
  before(:each) do
    assign(:aim / core_user, aim / core_user)
  end

  it 'renders the edit aim/core_user form' do
    render

    assert_select 'form[action=?][method=?]', aim / core_user_path(aim / core_user), 'post' do
