module Aim
  module Core
    class MapsController < ApplicationController
      before_action :set_aim_core_map, only: [:show, :edit, :update, :destroy]
      ...
      def aim_core_map_params
        params.require(:aim_core_map).permit(:name, :top_left_x, :top_left_y, :max_zoom, :bottom_right_x, :max_resolution, :bottom_right_y,
