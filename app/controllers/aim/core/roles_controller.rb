class Aim::Core::RolesController < ApplicationController
  before_action :set_aim_core_role, only: %i[ show edit update destroy ]
  ...
  private
    ...
    def aim_core_role_params
      params.require(:aim_core_role).permit(:created_at, :updated_at, :usage)
    end
end
