module Aim
  module Core
    class UsersController < ApplicationController
      before_action :set_aim_core_user, only: [:show, :edit, :update, :destroy]
      ...
      def aim_core_user_params
        params.require(:aim_core_user).permit(:serial_number, :name, :email, :encrypted_password, :reset_password_token,
