class Aim::Checklist::ChecklistGradeOptionsController < ApplicationController
  ...
  private
    ...
    def aim_checklist_checklist_grade_option_params
      params.require(:aim_checklist_checklist_grade_option).permit(:name, :grade, :incident_interface_id, :created_at, :updated_at, :comments, :pictures, :documents, :deleted_at, :default_tag_for_incident_id)
    end
end
