class Aim::Checklist::ChecklistCategoriesController < ApplicationController
  ...
  private
    ...
    def aim_checklist_checklist_category_params
      params.require(:aim_checklist_checklist_category).permit(:name, :icon_file_name, :icon_content_type, :icon_file_size, :icon_updated_at, :created_at, :updated_at, :filterable_by_auditor, :filterable_by_supervisor)
    end
end
